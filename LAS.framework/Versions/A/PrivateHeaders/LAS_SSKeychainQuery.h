...
typedef NS_ENUM(NSUInteger, LAS_SSKeychainQuerySynchronizationMode) {
	LAS_SSKeychainQuerySynchronizationModeAny,
	LAS_SSKeychainQuerySynchronizationModeNo,
	LAS_SSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface LAS_SSKeychainQuery : NSObject
...
@property (nonatomic) LAS_SSKeychainQuerySynchronizationMode synchronizationMode;
#endif
