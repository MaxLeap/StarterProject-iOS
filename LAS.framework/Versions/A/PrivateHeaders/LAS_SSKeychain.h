...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, LAS_SSKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	LAS_SSKeychainErrorBadArguments = -1001,
};

/** SSKeychain error domain */
extern NSString *const LAS_kSSKeychainErrorDomain;

/** Account name. */
extern NSString *const LAS_kSSKeychainAccountKey;
 ...
 */
extern NSString *const LAS_kSSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const LAS_kSSKeychainClassKey;

/** Item description. */
extern NSString *const LAS_kSSKeychainDescriptionKey;

/** Item label. */
extern NSString *const LAS_kSSKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const LAS_kSSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const LAS_kSSKeychainWhereKey;
 ...
 */
@interface LAS_SSKeychain : NSObject
