 ...
 */
@interface LASAnonymousUtils : NSObject
...
/*!
 ...
 @param block The block to execute when anonymous user creation is complete. The block should have the following argument signature: (LASUser *user, NSError *error)
 */
+ (void)logInWithBlock:(LASUserResultBlock)block;

/*! @name Determining Whether a LASUser is Anonymous */
